# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-08-09 02:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(max_length=108, verbose_name='磁盘型号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latest_date', models.DateField(auto_now=True, null=True, verbose_name='最后更新时间')),
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('business_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='repository.BusinessUnit', verbose_name='属于的业务线')),
